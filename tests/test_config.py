...
def test_load_config_valid(mock_path_exists: None) -> None:  # pylint: disable=unused-argument
...
def test_load_config_default_batch_size(mock_path_exists: None) -> None:  # pylint: disable=unused-argument
