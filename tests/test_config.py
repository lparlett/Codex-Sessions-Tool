...
def test_load_config_valid(_mock_path_exists: None) -> None:
...
def test_load_config_default_batch_size(_mock_path_exists: None) -> None:
...
def test_load_config_nonexistent_root() -> None:
    ...
    """
    with (
        patch("builtins.open", mock_open(read_data=mock_toml)),
